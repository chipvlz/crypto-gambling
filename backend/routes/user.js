...
router.post('/forgot_user_password', function(req, res) {
  ...
  .then((result) => {
      ...
      var mailOptions = {
        ...
        html: '<b><h3>We have received a password change request for your redexc account</h3></b><br>' +
        '<h3>If you did not ask to change your password, then you can ignore this email and your password will not be changed.</h3><br> ' +
        '<h3><a href="https://www.redexc.com/#/reset_password?pass_token=' + pass_token + '" target="R">Reset Password</a></h3>' // html body
      };
